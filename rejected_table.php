            ...
            <div class="container">
                <div class="main_big_title">
                    ...
                    <table id="search_area" align="left" style="padding-bottom: 20px;">
                        ...
                        if($sem1 != "" && $branch1 != ""){
                             $select_query = "select * from admission where sem = '$sem1' and branch  = '$branch1' and (action='2' or action2='rejected')";
                        }
                            ...
                            $select_query = "select * from admission where (action='2' or action2='rejected')";
                        }
