...
<head>
        ...
        <link href="css/responsive.css" rel="stylesheet">
        	...
        	<link href="assets/css/forhelp.css" rel="stylesheet">
    ...
    <div class="cd-faq__items">
        <ul id="basics" class="cd-faq__group">
             <li class="cd-faq__item">
                <a class="cd-faq__trigger" href="#0"><span>What is Hostel Management System?</span></a>
                <div class="cd-faq__content">
          <div class="text-component">
            <p>Hostel Management System is a web based application which provides a platform for managing various services/activities related to the hostel. This system is mainly designed to provide ease and efficiency in the admission process. All the process of admission like filling form, uploading documents, documents verfication, merit display and room alloaction is done online through our system. Our system also provides. other management features such as post complaints/query, fee payment, news letter, help desk, etc.</p>
          </div>
                </div> <!-- cd-faq__content -->
            </li>

            <li class="cd-faq__item">
                <a class="cd-faq__trigger" href="#0"><span>How admission process works?</span></a>
                <div class="cd-faq__content">
          <div class="text-component">
                <blockquote>Register yourself on hostel management system</blockquote>
                <blockquote>Fill the admission form with required documents</blockquote>
                <blockquote>Wait for your form to be reviewed and approved by authority</blockquote>
                <blockquote>Once approved, you are eligible for admission procedure</blockquote>
                <blockquote>Short-listing and room allocation based on selection procedure through website</blockquote>
