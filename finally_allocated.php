            ...
            <div class="container">
                <div class="banner_inner_content">
                    ...
                    <ul>
                        ...
                        <li><a href="room-list.html">Students</a></li>
                    </ul>
                </div>
            </div>
        </section>
       ...
       <section class="room_details_area">
            <div class="container">
                <div class="main_big_title">
                    <h2>finally allocated&nbsp<span>students</span></h2>
                    <?php
                    ...
                    <table id="search_area" align="left" style="padding-bottom: 20px;color: black;" class="container-fluid">
                        ...
                        if($sem1 != "" && $branch1 != ""){
                             $select_query = "select * from admission where sem = '$sem1' and branch  = '$branch1' and action2='finally_allocated'";
                        }

                        else if ($id1 != "" || $name1 != "" || $branch1 != "" || $sem1 != "" || $rank1 != "") {
                            $select_query = "select * from admission where (id = '$id1' or name = '$name1' or branch  = '$branch1' or sem = '$sem1' or rank  = '$rank1') and action2='finally_allocated'";
                            # code...
                        }
                        else{
                            $select_query = "select * from admission where action2='finally_allocated'";
                        }
                        ...
                        <tr>
                            ...
                            <td><form method="post" action="only_view_application.php"><a href=""><button type="submit">click here</button></a>
                            <input type="hidden" name="table_id" value= "<?php echo $result['id'];?>">
                              
                            </form>
                            </td>
                            <td><?php echo $result['action2'];?></td>
