                            ...
                            <ul class="nav navbar-nav">
                               ...
                               <!--  <li class="dropdown submenu active">
                                ...
                                <li class="submenu dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="Admission_application.php">NEW APPLICATIONS</a></li>
                                        <li><a href="upload_documents.php">APPROVED APPLICATIONS</a></li>
                                        <li><a href="Admission_status.php">REJECTED APPLICATION</a></li>
                                        <li><a href="Admission_status.php">ROOM ALLOCATION</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="submenu dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="complaint01.php">NEW COMPLAINTS</a></li>
                                        <li><a href="complaint02.php">PAST COMPLAINTS</a></li>
                                ...
                                <li class="submenu dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="complaint01.php">UPLOAD NOTICE</a></li>
                                        <li><a href="complaint02.php">UPLOADED NOTICE</a></li>
                                        
                                    </ul>
                                </li>
                                
                                <li><a href="fees.php">STUDENTS</a></li>
                                <!-- <li class="submenu dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Complaint <i class="fa fa-chevron-down" aria-hidden="true"></i></a> -->
                                    <!-- <ul class="dropdown-menu">
